...
namespace Flujo
{
    public class VehiculoFlujo : IVehiculoFlujo
    {
        ...
        public async Task<VehiculoDetalle> Obtener(Guid Id)
        {
            ...
            vehiculo.RegistroValido= await _registroReglas.VehiculoEstaRegistrado(vehiculo.Placa,vehiculo.CorreoPropietarios);
            vehiculo.RevisionValida= await _revisionReglas.RevisonEsValida(vehiculo.Placa);
